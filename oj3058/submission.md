...
```text
Input:
บรรทัดที่แรก อิฐเล็กที่มี (เป็น int)
บรรทัดที่ 2 อิฐใหญ่ที่มี (เป็น int)
บรรทัดที่ 3 ความยาวเป้าหมาย (เป็น int)

Output:
อิฐเล็กที่ต้องใช้ หรือ -1 หากต่อไม่ได้ (เป็น int)

Constraints:
อิฐเล็กมีความยาว 1 หน่วย
อิฐใหญ่ยาว 5 หน่วย
```
...
```text
Step 1: รับค่า small big และ goal (เป็น int)
Step 2: เช็กความยาวอิฐรวมทั้งหมดน้อยกว่า goal มั้ย หากน้อยกว่า Print "-1"
Step 3: ถ้ามากกว่าหรือเท่ากับ ไปเช็กต่อว่า goal เท่ากับ big * 5 หรือ น้อยกว่า ให้ Print big
Step 4: นอกเหนือจากนั้น ให้ Print (goal - (big * 5))
```
...
```text
แผนแรกผิด เพราะเอา goal ไป mod กับ big * 5 เลยเปลี่ยนมาเช็ก 3 กรณี:
หาก big * 5 ค่าเท่ากับ goal ตอบ 0
หาก big * 5 มากกว่า goal เช็ก goal mod กับ 5 ว่าถ้ามีอิฐเล็กพอ ก็ตอบผล mod นอกนั้นตอบ -1
หาก big * 5 น้อยกว่า goal เช็กว่าถ้าอิฐรวมกันพอตอบ goal - (big * 5) ถ้านอกนั้นตอบ -1
```
...
```text
อิฐใหญ่เกิน แต่ไม่พอดีเป๊ะกับเป้า
```

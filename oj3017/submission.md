...
```text
Input:
รับค่าราคาอาหารเป็น int

Output:
ราคาสุทธิเป็น float ทศนิยม 2 ตำแหน่ง

Constraints:
Service Charge คิด 10% ต้องไม่ต่ำกว่า 50 บาท และไม่เกิน 1000 บาท
```
...
```text
Step 1: รับค่า integer ของตัวแปร price
Step 2: คำนวณ Service Charge 10% ของ price
Step 3: เช็ก Service Charge ถ้าต่ำกว่า 50 ให้เท่ากับ 50 ถ้าตั้งแต่ 1000 ขึ้นไปให้เท่ากับ 1000
Step 4: คำนวณ VAT 7% จาก price บวก service
Step 5: รวมราคาสุทธิ net = price + service + vat
Step 6: Print net ออกมาเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
Service Charge อยู่ในช่วงปกติ ต้องการทดสอบโค้ด
```

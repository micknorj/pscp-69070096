...
```text
Input:
รับค่า x และ y เป็น int

Output:
จำนวนครั้งที่กระโดดถึงระยะที่กำหนด หรือ -1 ถ้าไปไม่ถึง

Constraints:
รับ Input บรรทัดเดียว
```
...
```text
Step 1: รับค่า x และ y เป็น int
Step 2: ตั้ง count เป็น 1 และ distance เท่ากับ x
Step 3: ใช้ while loop วนจน distance ถึง y
Step 4: เพิ่ม count ทีละ 1 ลด x ทีละ 2 แล้วบวก x เข้า distance
Step 5: ถ้า x เท่ากับ 0 แล้วยังไม่ถึง y ให้ count เป็น -1
Step 6: Print count
```
...
Step 2: ตั้ง count เป็น 1 และ distance เท่ากับ x
Step 3: ใช้ while loop วนจน distance ถึง y
Step 4: เพิ่ม count ทีละ 1 แล้วลด x ทีละ 2 จากนั้นบวก x เข้า distance
Step 5: ถ้า x เท่ากับ 0 แล้วยังไม่ถึง y ให้ count เป็น -1
Step 6: Print count
```

...
```text
Input:
รับข้อความชื่อสีเป็น string 2 บรรทัด

Output:
ชื่อสีที่ได้จากการผสม หรือ Error

Constraints:
สีต้องเป็น Red Yellow หรือ Blue และ Case-sensitive
```
...
```text
Step 1: รับค่า String 2 ตัวแปร a และ b
Step 2: สร้าง List เก็บแม่สี 3 สี ["Red", "Yellow", "Blue"]
Step 3: เช็กว่าทั้งสองสีอยู่ใน List แม่สี หากไม่อยู่ให้ Print "Error"
Step 4: เช็กเงื่อนไขการผสมสีตามตรรกะ แดงบวกเหลืองได้ส้ม แดงบวกน้ำเงินได้ม่วง เหลืองบวกน้ำเงินได้เขียว แต่ถ้าเป็นสีเดียวกันทั้งคู่ ให้ Print สีเดิมออกมา
```

...
```text
Input:
รับข้อความเป็น string

Output:
ข้อความเรียงใหม่ เริ่มจากตัวท้ายมาตัวหน้า

Constraints:
แปลงข้อความเป็นตัวพิมพืเล็กทั้งหมด
```
...
```text
Step 1: รับค่า String
Step 2: ทำให้ทุกตัวเป้นตัวพิมพ์เล็ก
Step 3: Print ตัวอักษรจากหลังไปหน้าด้วย Index Slicing
```

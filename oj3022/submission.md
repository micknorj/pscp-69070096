...
```text
Input:
บรรทัดแรก ตัวเลขอุณหภูมิ (float)
บรรทัดที่ 2 หน่วยต้นทาง (string)
บรรทัดที่ 3 หน่วยปลายทาง (string)

Output:
อุณหภูมิที่แปลงทศนิยม 2 ตำแหน่ง (float)
...
```text
Step 1: รับค่า digits เป็น float และ unit กับ desired เป็น string
Step 2: เช็กว่า unit และ desired เป็นหน่วยเดียวกันหรือไม่
Step 3: ถ้าคนละหน่วย จะเช็กหน่วยที่ต้องการแปลง แล้วคำนวณตามสูตรอุณหภูมินั้น เก็บใน result
Step 4: หากเป็นหน่วยเดียวกัน ใช้ค่า digits เดิม
Step 5: Print ผลลัพธ์ทศนิยม 2 ตำแหน่ง
```

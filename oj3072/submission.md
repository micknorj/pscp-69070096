...
```text
Input:
บรรทัดแรก ข้อความ (เป็น string)

Output:
สระและจำนวนที่มีมากกว่า 0 แบบแยกบรรทัด (string)
...
```text
Step 1: รับค่า word เป็น string แล้วแปลงเป็นตัวพิมพ์เล็ก
Step 2: ตั้งค่าตัวแปรที่จะใช้นับสระ va ve vi vo vu และ count เป็น 0
Step 3: ใช้ for loop วนตามความยาวของ word
Step 4: เช็กตัวอักษรทีละตำแหน่ง ถ้าตรงกับ a e i o u ก็บวกค่าสระนั้นทีละ 1 แล้วบวก count เพิ่ม
Step 5: ถ้าตัวแปรสระไหนมากกว่า 0 ให้ Print ชื่อสระตามด้วยจำนวน
```
...
```text
เหมือนแผนแรก ผมใช้ .lower() แปลงข้อความก่อน แล้วค่อยใช้ for loop เช็กตัวอักษรทีละตัวด้วย index slicing เพื่อเพิ่มค่า count ของสระแต่ละตัว จากนั้นแสดงผลเฉพาะสระที่มีค่ามากกว่า 0
```

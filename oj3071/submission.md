...
```text
Input:
บรรทัดที่แรก ค่า A เป็น int
บรรทัดที่ 2 ค่า B เป็น int
บรรทัดที่ 3 ตัวหาร d เป็น int
บรรทัดที่ 4 เศษ r เป็น int

Output:
จำนวนที่ตรงตามเงื่อนไขเป็น int

Constraints:
นับรวมตั้งแต่ A ถึง B
```
...
```text
Step 1: รับค่า digit_A digit_B divisor remainder เป็น int และตั้ง count เป็น 0
Step 2: เช็กว่า digit_A น้อยกว่า digit_B
Step 3: ใช้ for loop วนตั้งแต่ digit_A ถึง digit_B
Step 4: เช็กว่าถ้า i % divisor ค่าเท่ากับ remainder ให้บวก count เพิ่มทีละ 1
Step 5: Print ค่า count
```
...
```text
เหมือนแผนแรก ใช้ for loop วนตั้งแต่ digit_A ถึง digit_B + 1 เพื่อเช็กตัวเลขทีละตัวด้วย i % divisor มีค่าเท่ากับ remainder ถ้านับลงตัวก็เพิ่ม count แล้ว Print ผลออกมา
```
...
```text
ไม่มีตัวเลขตรงตามเงื่อนไขที่ต้องการ
```

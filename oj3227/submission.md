...
```text
Step 1: รับค่า card เป็น string แล้วแปลงเป็นตัวพิมพ์ใหญ่
Step 2: สร้าง Dictionary เก็บชื่อไพ่และชื่อดอก
Step 3: แยกตัวหน้าเป็นเลขไพ่ และตัวท้ายเป็นดอกไพ่
Step 4: เช็กค่าใน Dictionary แล้วเปลี่ยนเป็นชื่อเต็ม
Step 5: Print ผลออกมา
```
...
```text
เหมือนแผนแรก ใช้ Dict เก็บไพ่และดอก แล้วแยกตัวหน้าและท้ายของ card เพื่อเช็กใน Dictionary แล้วค่อยเปลี่ยนเป็นชื่อเต็มแล้ว Print ผล
```

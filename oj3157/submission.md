...
```text
Input:
รับ turn เป็น int และรับ action ตามจำนวนรอบ

Output:
คะแนนรวมหลังทำ action ครบทุกครั้ง

Constraints:
ถ้าเป็น + เพิ่ม 10 นอกนั้นลด 5
```
...
```text
Step 1: รับค่า turn เป็น int และตั้ง value เป็น 0
Step 2: ใช้ for loop วนตามจำนวน turn
Step 3: รับค่า action ในแต่ละรอบ
Step 4: ถ้า action เป็น + ให้บวก value 10 นอกนั้นลบ 5
Step 5: Print value
```
...
```text
เหมือนแผนแรก ใช้ for loop วนตามจำนวน turn เพื่อรับ action ทีละรอบ ถ้าเป็น + ให้เพิ่ม value 10 นอกนั้นลด 5 แล้ว Print value ออกมา
```
